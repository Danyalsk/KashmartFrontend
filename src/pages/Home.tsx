      ...
      <main className="space-y-10 mt-4">
        ...
        <section>
          ...
          <div className="flex gap-4 overflow-x-auto no-scrollbar px-5 pb-4">
            {bestsellers.map((item, i) => (
              <div 
                key={i} 
                className="min-w-[180px] flex flex-col bg-surface-light dark:bg-surface-dark rounded-3xl p-3 shadow-sm border border-slate-50 dark:border-slate-800 cursor-pointer active:scale-95 transition-transform"
        ...
        <section className="px-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <div 
              className="relative rounded-[32px] overflow-hidden shadow-lg aspect-[4/3] cursor-pointer active:scale-95 transition-transform"
              onClick={() => navigate('/product/' + featuredHero.id)}
            >
              <img alt={featuredHero.name} className="w-full h-full object-cover" src={featuredHero.image}/>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                <div className="text-white">
                  ...
                  <h4 className="text-2xl font-bold">{featuredHero.name}</h4>
                  <p className="text-white/70 text-sm">Unfiltered, raw nectar from the deep valley.</p>
                  <p className="text-xl font-bold mt-2">₹{featuredHero.price} <span className="text-xs font-normal text-white/60">/ {featuredHero.weight}</span></p>
                </div>
        ...
        <section>
          ...
          <div className="flex gap-4 overflow-x-auto no-scrollbar px-5 pb-4">
            {teas.map((tea, i) => (
              <div 
                key={i} 
                className={`min-w-[280px] bg-surface-light dark:bg-surface-dark rounded-[32px] p-5 flex gap-4 border border-slate-100 dark:border-slate-800 cursor-pointer active:scale-95 transition-transform`}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-slate-500 uppercase font-bold tracking-wider mb-2">{tea.category}</p>
